...
const ProfileWithDescription = (props:propTypes) => {
  ...
  return (
    <section className='w-full h-full flex flex-col justify-center items-center gap-2 text-2xl text-white'>
      ...
      <h1>{Name}</h1>
      <figure className="w-[35%] h-[10%] text-lg flex justify-center items-center gap-2">
